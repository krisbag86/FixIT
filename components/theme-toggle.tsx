...
export function ThemeToggle() {
  ...
  const label = dark === null ? "Zmień motyw" : dark ? "Włącz jasny motyw" : "Włącz ciemny motyw";
  ...
  return (
    ...
    >
      {dark === true ? <Sun size={18} className="transition-transform duration-300 hover:rotate-45" /> : <Moon size={18} className="transition-transform duration-300 hover:-rotate-12" />}
    </button>
  );
}
